...
remove_first_key = sort_v_b_ratio_tuple[IoT_SIZE * BS_SIZE - 1][0][0]
remove_second_key = sort_v_b_ratio_tuple[IoT_SIZE * BS_SIZE - 1][0][1]
# print(sort_v_b_ratio)
